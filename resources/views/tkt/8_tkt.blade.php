        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                        <td>Merupakan tingkat dimana teknologi perangkat lunak terintegrasi sepenuhnya dengan perangkat
                            keras dan lunak dari sistem operasional</td>
                        <td>
                    ...
                    <tr>
                        <td>2</td>
                        <td>Dokumentasi pengembangan perangkat lunak lengkap </td>
                        <td>
                            <div class="form-group">
                    ...
                    <tr>
                        <td>3</td>
                        <td>Semua fungsi diuji baik dalam skenario simulasi maupun operasional
                        </td>
                        <td>
                            <div class="form-group">
