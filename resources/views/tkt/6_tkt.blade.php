        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                        <td>Merupakan tingkat dimana kelayaka rekayasa dari teknologi perangkat lunak di tunjukkan</td>
                        <td>
                    ...
                    <tr>
                        <td>2</td>
                        <td>Mencakup juga implementasi prototipe laboratorium dengan permasalahan realistik skala
                            penuh, dimana teknologi perangkat lunak terintegrasi secara parsial dengan perangkat keras/lunak
                            dari sistem eksisting.</td>
                        <td>
                            <div class="form-group">
